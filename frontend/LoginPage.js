...
const Login = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginTop: 10 }}>
        <Text onPress={ () => { navigation.navigate("MyChat");}} styles={styles.fontEng}>ยังไม่มีสมาชิก</Text>
        <Text onPress={ () => { navigation.navigate("Notification");}} style={styles.fontTh} color="#4542C1">สมัครสมาชิกใหม่?</Text>
        <View styles={{ backgroundColor: '#FFFFFF' }}>
